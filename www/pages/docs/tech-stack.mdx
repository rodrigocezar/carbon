...
We have a package called [@carbon/react](https://github.com/barbinbrad/carbon/tree/main/packages/carbon-react/src) that has a bunch of React pre-built components that you can use to build your UI. You can also use any other React component library.
