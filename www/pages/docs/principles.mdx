...
- Minimal languages and setup (npm, TypeScript and SQL)
...
The ERP system is the heart of a business' digital operation. We want to make sure that they can easily integrate with other systems and customize it in any way that they need. **The only real way to do this that to make the source code available**.
